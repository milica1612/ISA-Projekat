...
public class PharmacyService implements IPharmacyService {
	...
	public Pharmacy createPharmacy(PharmacyDTO pharmacyDTO) {
		...
		address.setStreet(pharmacyDTO.getStreet());
		address.setStreetNumber(pharmacyDTO.getStreetNumber());
		address.setCity(pharmacyDTO.getCity());
		address.setCountry(pharmacyDTO.getCountry());
		address.setLongitude(null);
		address.setLatitude(null);
		
		Pharmacy pharmacy = new Pharmacy();
		
		pharmacy.setAdress(address);
		pharmacy.setName(pharmacyDTO.getName());
		pharmacy.setDescription(pharmacyDTO.getDescription());
		pharmacy.setRating(pharmacyDTO.getRaiting());
