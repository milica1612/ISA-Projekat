...
export default {
  ...
  methods: {
    initialize() {
      this.axios
        .get("http://localhost:8091/dermatologistVacation/allWithStatusWaiting", {
          headers: {
    ...
    acceptRequest() {
      ...
      this.axios
        .post(
          "http://localhost:8091/dermatologistVacation/accept",
          {
    ...
    declineRequest() {
      ...
      this.axios
        .post(
          "http://localhost:8091/dermatologistVacation/decline",
          {
            vacationId: this.vacatoionId,
