Vue.component("supplier", {
	...
	<div style = "margin-top: 10px;">
		...
		<td><a href style = "background-color:SlateBlue; padding: 10px; border: none; cursor: pointer; width:300%; opacity: 0.9;" v-bind:disabled = "mode != 'BROWSE'">Create Offer</button></td></tr>
		</table>
